...
[Tutorials](https://www.youtube.com/watch?v=uBP9z0bw5jk&list=PL-Qfhn8ALmAzt76BRppKsxn14X7z-cxCE) (open CC subtitles for
English)
...
Restart is required if Untenshi signs cannot be detected.<br/> (The error should contain `zip file closed` in the
console)<br/>
